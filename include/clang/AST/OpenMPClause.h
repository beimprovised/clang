...
///
        class OMPIfClause : public OMPClause, public OMPClauseWithPreInit {
                ...
                public:
                        ...
                        /// \param EndLoc Ending location of the clause.
                        ///
                        OMPIfClause(OpenMPDirectiveKind NameModifier, Expr *Cond, Stmt *HelperCond, SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation NameModifierLoc, SourceLocation ColonLoc, SourceLocation EndLoc)
...
///
        class OMPNumThreadsClause : public OMPClause, public OMPClauseWithPreInit {
                ...
                public:
                        ...
                        /// \param EndLoc Ending location of the clause.
                        ///
                        OMPNumThreadsClause(Expr *NumThreads, Stmt *HelperNumThreads, SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc)
...
///
        class OMPScheduleClause : public OMPClause, public OMPClauseWithPreInit {
                ...
                void setScheduleModifer(OpenMPScheduleClauseModifier M){
                        if(Modifiers[FIRST] == OMPC_SCHEDULE_MODIFIER_unknown) Modifiers[FIRST] = M;
                        else{
...
///
        class OMPPrivateClause final
                ...
                /// \param N Number of the variables in the clause.
                ///
                OMPPrivateClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
...
///
        class OMPFirstprivateClause final
                ...
                /// \param N Number of the variables in the clause.
                ///
                OMPFirstprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
...
/// with the variables 'a' and 'b'.
        class OMPLastprivateClause final
                ...
                /// \param N Number of the variables in the clause.
                ///
                OMPLastprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
...
///
        class OMPSharedClause final
                ...
                /// \param N Number of the variables in the clause.
                ///
                OMPSharedClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
...
///
        class OMPReductionClause final
                ...
                ///
                OMPReductionClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation ColonLoc, SourceLocation EndLoc, unsigned N, NestedNameSpecifierLoc QualifierLoc, const DeclarationNameInfo &NameInfo)
...
///
        class OMPAlignedClause final
                ...
                /// \param NumVars Number of variables.
                ///
                OMPAlignedClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation ColonLoc, SourceLocation EndLoc, unsigned NumVars)
...
///
        class OMPCopyinClause final
                ...
                /// \param N Number of the variables in the clause.
                ///
                OMPCopyinClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
...
///
        class OMPCopyprivateClause final
                ...
                /// \param N Number of the variables in the clause.
                ///
                OMPCopyprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
...
///
        class OMPFlushClause final
                ...
                /// \param N Number of the variables in the clause.
                ///
                OMPFlushClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
...
///
        class OMPDependClause final
                ...
                /// \param N Number of the variables in the clause.
                ///
                OMPDependClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
...
///
        class OMPDeviceClause : public OMPClause {
                ...
                public:
                        ...
                        OMPDeviceClause(HOMPDeviceSpecifierExpr *E, SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc)
                                : OMPClause(OMPC_device, StartLoc, EndLoc), LParenLoc(LParenLoc)
                                  , Device(E){}
...
//        class HOMPDeviceClause : public OMPDeviceClause {
//                std::vector<HOMPDeviceSpecifierExpr &> HOPMDevices;
//                HOMPDeviceClause(){}
//        };

#ifdef REDEFINE_DEVICE
        class OMPHybridDeviceClause
                : public OMPClause {
                std::vector<OMPDeviceClause *> HOPMDevices;
                OMPHybridDeviceClause() : OMPClause(OMPC_device, SourceLocation(), SourceLocation())
                ...
                public:
                        ...
                        class MappableComponent {
                                ...
                                public:
                                        ...
                                        explicit MappableComponent(Expr *AssociatedExpression, ValueDecl *AssociatedDeclaration)
                        ...
                        class const_component_lists_iterator
                                ...
                                public:
                                        ...
                                        explicit const_component_lists_iterator(
                                                ArrayRef<ValueDecl *> UniqueDecls, ArrayRef<unsigned> DeclsListNum, ArrayRef<unsigned> CumulativeListSizes, MappableExprComponentListRef Components)
                                                ...
                                                if(! DeclsListNum.empty()) RemainingLists = *NumListsCur;
                                        }

                                        /// \brief Construct an iterator that scan lists for a given declaration \a
                                        /// Declaration.
                                        explicit const_component_lists_iterator(
                                                const ValueDecl *Declaration, ArrayRef<ValueDecl *> UniqueDecls, ArrayRef<unsigned> DeclsListNum, ArrayRef<unsigned> CumulativeListSizes, MappableExprComponentListRef Components)
...
///
        class OMPMapClause final : public OMPMappableExprListClause<OMPMapClause>
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPMapClause(OpenMPMapClauseKind MapTypeModifier, OpenMPMapClauseKind MapType, bool MapTypeIsImplicit, SourceLocation MapLoc, SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
...
///
        class OMPNumTeamsClause : public OMPClause, public OMPClauseWithPreInit {
                ...
                public:
                        ...
                        /// \param EndLoc Ending location of the clause.
                        ///
                        OMPNumTeamsClause(Expr *E, Stmt *HelperE, SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc)
...
///
        class OMPThreadLimitClause : public OMPClause, public OMPClauseWithPreInit {
                ...
                public:
                        ...
                        /// \param EndLoc Ending location of the clause.
                        ///
                        OMPThreadLimitClause(Expr *E, Stmt *HelperE, SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc)
...
///
        class OMPToClause final : public OMPMappableExprListClause<OMPToClause>
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPToClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPToClause(unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
                        : OMPMappableExprListClause(
...
///
        class OMPFromClause final
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPFromClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPFromClause(unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
                        : OMPMappableExprListClause(
...
///
        class OMPUseDevicePtrClause final
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPUseDevicePtrClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPUseDevicePtrClause(unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
...
///
        class OMPIsDevicePtrClause final
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPIsDevicePtrClause(SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc, unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
                ...
                /// \param NumComponents Total number of expression components in the clause.
                ///
                explicit OMPIsDevicePtrClause(unsigned NumVars, unsigned NumUniqueDeclarations, unsigned NumComponentLists, unsigned NumComponents)
