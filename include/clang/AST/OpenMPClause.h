...
///
    ...
    class OMPDefaultDeviceClause : public OMPClause {
        friend class OMPClauseReader;
        /// \brief Location of '('.
        SourceLocation LParenLoc;
        /// \brief Device number.
        ...
        public:
            ...
            /// \param EndLoc Ending location of the clause.
            ///
            OMPDefaultDeviceClause(Expr *E, SourceLocation StartLoc, SourceLocation LParenLoc, SourceLocation EndLoc)
                : OMPClause(OMPC_defaultdevice, StartLoc, EndLoc), LParenLoc(LParenLoc)
                  , Device(E){}

            /// \brief Build an empty clause.
            ///
            OMPDefaultDeviceClause()
                : OMPClause(OMPC_defaultdevice, SourceLocation(), SourceLocation())	// ?
                  , LParenLoc(SourceLocation()), Device(nullptr){}
            /// \brief Sets the location of '('.
            void setLParenLoc(SourceLocation Loc){LParenLoc = Loc;}
            /// \brief Returns the location of '('.
            ...
            static bool classof(const OMPClause *T){
                return T->getClauseKind() == OMPC_defaultdevice;
            }
